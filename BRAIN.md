...
- Status: implemented on 2026-06-29 after Phase 7C. Phase 8A localization is explicitly deferred and has not started.
...
- Handoff notes: Phase 8 core is complete. Future Phase 8A localization can start separately if desired; it should preserve the static architecture and avoid changing the resume PDF unless explicitly requested.
